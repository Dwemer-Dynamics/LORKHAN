...
enum class GameDataType { item_pickup, spell_cast, actor_resurrected, inventory, captured_dialogue, actor_profile, automatic_diary, rpg_event, bored_event, quest_event, disposition };
