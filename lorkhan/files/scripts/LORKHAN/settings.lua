...
I.Settings.registerGroup({
    ...
    settings={
        ...
        {key='combatBarkInterval',renderer='number',default=0,name='CombatBarkPeriod_name',description='CombatBarkPeriod_description',argument={integer=true,min=0,max=600}},
