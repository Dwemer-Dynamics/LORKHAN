...
I.Settings.registerGroup({
    ...
    settings={
        ...
        {key='OpenMicBinding',renderer='lorkhanBinding',default=bindings.openMic,
        ...
        {key='StopDialogueBinding',renderer='lorkhanBinding',default=bindings.stopDialogue,
        ...
        {key='ActorToolsBinding',renderer='lorkhanBinding',default=bindings.actorTools,
