...
function M.bridge()
 local bridge={submitted={},results={},actionResults={},cancelled={},prepared={},media={},played={},stopped=0,halted=false,
 ...
 function bridge.submitActionResult(dto) table.insert(bridge.actionResults,dto) return dto.request_id end
